...
let modulePaths = {
 ...
 "packages/login_demo/main": "packages/login_demo/main.ddc",
 "packages/login_demo/main_web_entrypoint": "packages/login_demo/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/login_demo/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:login_demo/main_web_entrypoint.dart") {
          // Clear static caches.
