define(['dart_sdk', 'packages/flutter/material', 'packages/flutter/src/widgets/actions', 'packages/flutter/src/rendering/animated_size'], function(dart_sdk, packages__flutter__material, packages__flutter__src__widgets__actions, packages__flutter__src__rendering__animated_size) {
  ...
  dart.defineLazy(CT, {
    ...
    get C0() {
      return C0 = dart.const({
        ...
        [_Location_column]: 13,
        [_Location_line]: 23,
        [_Location_file]: "org-dartlang-app:///packages/login_demo/main.dart"
      });
    },
    get C5() {
  ...
  dart.setLibraryUri(main.MyApp, "package:login_demo/main.dart");
  ...
  dart.setLibraryUri(main.MyHomePage, "package:login_demo/main.dart");
  ...
  dart.setLibraryUri(main._MyHomePageState, "package:login_demo/main.dart");
  ...
  dart.trackLibraries("packages/login_demo/main", {
    "package:login_demo/main.dart": main
  }, {
