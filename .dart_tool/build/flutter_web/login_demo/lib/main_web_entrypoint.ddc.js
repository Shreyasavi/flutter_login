define(['dart_sdk', 'packages/login_demo/main'], function(dart_sdk, packages__login_demo__main) {
  'use strict';
  ...
  const main = packages__login_demo__main.main;
  ...
  dart.trackLibraries("packages/login_demo/main_web_entrypoint", {
    "package:login_demo/main_web_entrypoint.dart": main_web_entrypoint
  }, {
